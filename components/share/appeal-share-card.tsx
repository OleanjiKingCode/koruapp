  ...
  ({ appeal, variant = "default", className }, ref) => {
    ...
    if (variant === "compact") {
      return (
        <div
          ref={ref}
          className={`w-[320px] sm:w-[400px] h-[180px] sm:h-[220px] relative overflow-hidden ${className}`}
          style={{
        ...
        >
          ...
          {/* Mobile Layout */}
          <div className="sm:hidden relative z-10 h-full p-3 flex flex-col">
            {/* Compact Header - Profile + Trend in one line */}
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                {appeal.targetProfileImage ? (
                  ...
                  <div className="w-9 h-9 rounded-lg overflow-hidden">
                    <AvatarGenerator seed={appeal.targetHandle} size={36} />
                  </div>
                )}
              ...
              >
                ...
                <span className="text-xs font-bold">+{appeal.trendValue}%</span>
              </div>
            </div>

            {/* Tags - Single row, scrollable if needed */}
            {topTags.length > 0 && (
              <div className="flex items-center gap-1 mb-2 overflow-x-auto scrollbar-none">
                {topTags.slice(0, 2).map((tag) => {
                  ...
                  return (
                    <span
                      key={tag}
                      className="px-1.5 py-0.5 rounded-md text-[9px] font-medium whitespace-nowrap flex-shrink-0"
              ...
              <div className="flex items-end justify-between">
                <div className="flex items-baseline gap-3">
                  <div>
                    ...
                    <p className="text-[9px] text-neutral-400">pledged</p>
                  </div>
                  <div>
                    <p className="text-lg font-black text-[#c385ee]">
                      {appeal.backers}
                    </p>
                    <p className="text-[9px] text-neutral-400">backers</p>
                  </div>
                </div>
                <img
                  src="/logo.png"
          ...
          {/* Desktop Layout */}
          <div className="hidden sm:flex relative z-10 h-full p-6 flex-col">
            {/* Header */}
    ...
    if (variant === "vibrant") {
      return (
        <div
          ref={ref}
          className={`w-[320px] sm:w-[480px] h-[200px] sm:h-[280px] relative overflow-hidden rounded-2xl sm:rounded-3xl ${className}`}
          style={{
            background:
        ...
        >
          ...
          {/* Mobile Layout */}
          <div className="sm:hidden relative z-10 h-full p-4 flex flex-col">
              ...
              <div className="flex items-center gap-2 min-w-0">
                {appeal.targetProfileImage ? (
                  ...
                  <div
                    ...
                    style={{ border: "2px solid rgba(255,255,255,0.3)" }}
                  >
                    <AvatarGenerator seed={appeal.targetHandle} size={40} />
                  </div>
                )}
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-white/60 truncate">{appeal.targetName}</p>
                </div>
              </div>
              {topTags.length > 0 && (
                <span
                  className="px-2 py-0.5 rounded-lg text-[9px] font-bold uppercase tracking-wider flex-shrink-0"
                  style={{
            ...
            <div className="space-y-2">
              <div className="flex items-baseline gap-4">
                ...
                <div>
                  <p className="text-2xl font-black text-[#9deb61]">
                    {appeal.backers}
                  </p>
                  <p className="text-[9px] text-white/50 font-medium">Backers</p>
                </div>
              </div>
          ...
          {/* Desktop Layout */}
          <div className="hidden sm:flex relative z-10 h-full p-8 flex-col">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                {appeal.targetProfileImage ? (
                  <img
          ...
          <div className="sm:hidden relative z-10 h-full p-4 flex flex-col">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                <div className="w-1.5 h-1.5 rounded-full bg-[#dab079] animate-pulse" />
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-white/40 truncate">{appeal.targetName}</p>
              </div>

              {topTags.length > 0 && (
                <span
                  className="px-2 py-0.5 rounded-lg text-[9px] font-bold flex-shrink-0"
                  style={{
            ...
            <div className="flex items-end justify-between">
              <div className="flex items-baseline gap-3">
                <div>
                  <p className="text-xl font-black text-[#dab079]">
                    ${formatNumber(appeal.totalPledged)}
                  </p>
                  <p className="text-[9px] text-white/30">Pledged</p>
                </div>
                <div>
                  <p className="text-xl font-black text-white">
                    {appeal.backers}
                  </p>
                  <p className="text-[9px] text-white/30">Backers</p>
                </div>
              </div>
    ...
    return (
      <div
        ref={ref}
        className={`w-[320px] sm:w-[480px] h-[180px] sm:h-[240px] relative overflow-hidden rounded-2xl sm:rounded-3xl ${className}`}
        style={{
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-neutral-500 truncate">{appeal.targetName}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-end gap-1 flex-shrink-0">
              {topTags.length > 0 ? (
                <span
                  ...
                  style={{ 
                    background: getTagStyle(topTags[0]).bg, 
                    color: getTagStyle(topTags[0]).text 
                  }}
                >
                  {topTags[0]}
                </span>
          ...
          <div className="flex items-end justify-between">
            <div className="flex items-baseline gap-3">
              ...
              <div className="pl-3 border-l border-neutral-200">
                <p className="text-xl font-black text-[#c385ee]">
                  {appeal.backers}
                </p>
                <p className="text-[9px] text-neutral-400">Backers</p>
              </div>
            ...
            <img
              src="/logo.png"
              alt="Koru"
              className="w-6 h-6 rounded-lg object-cover shadow-md"
            />
          </div>
        </div>

        {/* Desktop Layout */}
        <div className="hidden sm:block relative z-10 h-full p-8 flex flex-col">
