    ...
    case "chat":
      return (
        <svg className={className} viewBox="0 0 48 48" fill="none">
          ...
          <path d="M24 28 L22 32 L26 32 Z" fill="currentColor" fillOpacity="0.6" />
          {/* Chat bubble */}
          <path d="M34 6 L44 6 Q46 6 46 8 L46 16 Q46 18 44 18 L38 18 L36 22 L36 18 L34 18 Q32 18 32 16 L32 8 Q32 6 34 6 Z" fill="currentColor" fillOpacity="0.4" />
    ...
    case "inbox":
      return (
        <svg className={className} viewBox="0 0 48 48" fill="none">
          ...
          <circle cx="24" cy="26" r="18" fill="currentColor" fillOpacity="0.2" />
          {/* Eyes - happy/closed */}
          <path d="M14 24 Q18 20 22 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
          <path d="M26 24 Q30 20 34 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
          {/* Beak */}
          <path d="M24 28 L22 32 L26 32 Z" fill="currentColor" fillOpacity="0.6" />
          {/* Inbox tray */}
          <rect x="32" y="6" width="14" height="12" rx="2" stroke="currentColor" strokeWidth="2" fill="none" />
          <path d="M32 12 L36 12 L38 15 L40 12 L46 12" stroke="currentColor" strokeWidth="2" fill="none" />
        </svg>
      );
    case "wallet":
      return (
        <svg className={className} viewBox="0 0 48 48" fill="none">
          ...
          <path d="M24 28 L22 32 L26 32 Z" fill="currentColor" fillOpacity="0.6" />
          {/* Wallet */}
          <rect x="32" y="8" width="12" height="10" rx="2" stroke="currentColor" strokeWidth="2" fill="none" />
