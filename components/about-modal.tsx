...
function AboutContent() {
  return (
    <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12 pb-10">
      {/* Title */}
      <motion.h1
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.2 }}
        className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-tenor text-neutral-900 dark:text-neutral-100"
      >
        The point of{" "}
      ...
      <motion.section
        ...
        className="space-y-4"
      >
        <p className="text-base sm:text-lg md:text-xl text-neutral-700 dark:text-neutral-300 leading-relaxed font-quicksand">
          Right now, the internet is broken in one painful way:
        </p>
        <p className="text-lg sm:text-xl md:text-2xl text-neutral-900 dark:text-neutral-100 font-tenor">
          <TextHighlight type="underline" color="#ef4444" delay={0.1}>
            Access is random.
          </TextHighlight>
        </p>
        <p className="text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed font-quicksand">
      ...
      >
        ...
        <ul className="space-y-3 text-base sm:text-lg md:text-xl text-neutral-700 dark:text-neutral-300 font-quicksand">
      ...
      <motion.section
        ...
        className="space-y-4"
      >
        <p className="text-base sm:text-lg md:text-xl text-neutral-700 dark:text-neutral-300 font-quicksand">
          It saves people from:
        </p>
        <ul className="space-y-3 text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-400 font-quicksand pl-6">
      ...
      <motion.section
        ...
        className="space-y-6"
      >
        <h2 className="text-xl sm:text-2xl md:text-3xl font-tenor text-neutral-900 dark:text-neutral-100">
          What Kōru is
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl text-neutral-800 dark:text-neutral-200 font-quicksand leading-relaxed">
          Kōru is a{" "}
        ...
        <div className="space-y-3 text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-400 font-quicksand">
      ...
      >
        ...
        <ul className="space-y-2 text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-400 font-quicksand pl-6">
          <li className="list-disc">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-neutral-900 dark:text-neutral-100 font-tenor pt-2">
          …and{" "}
          <TextHighlight type="highlight" color="#9deb61" delay={0.5}>
      ...
      >
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-700 dark:text-neutral-300 font-quicksand leading-relaxed">
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-600 dark:text-neutral-400 font-quicksand leading-relaxed">
          A system where{" "}
          <TextHighlight type="underline" color="#dab079" delay={0.3}>
            attention has value
          </TextHighlight>,{" "}
      ...
      >
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-tenor text-neutral-900 dark:text-neutral-100">
...
export function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DrawerContent className="overflow-hidden border-0 rounded-t-[24px] bg-neutral-50 dark:bg-neutral-900">
        <DrawerTitle className="sr-only">About Kōru</DrawerTitle>
        <div className="px-4 pb-6 max-h-[85dvh] overflow-y-auto" data-vaul-no-drag>
          <AboutContent />
        </div>
      </DrawerContent>
    </Drawer>
